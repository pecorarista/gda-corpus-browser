...
<!-- XSL file for News GDA corpus
     not insert new line for each sentence
     use `gda.js' as java script
-->

<xsl:import href="iwa_attr.xsl"/>
<xsl:import href="iwa_docstr.xsl"/>
<xsl:import href="common.xsl"/>

<xsl:variable name="js_file">gda.js</xsl:variable>
