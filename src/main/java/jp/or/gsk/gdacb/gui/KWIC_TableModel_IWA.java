...
public class KWIC_TableModel_IWA extends KWIC_TableModel {
	...
	public static final ColumnContext[] columnArray = {
		...
		new ColumnContext("辞書見出し", String.class, false, 120)
    };
	// 「左文脈」に該当する列のインデックス
	...
	KWIC_TableModel_IWA(RetrievedKeyword_IWA[] rkl){
		super();
		this.set_columnArray(columnArray);
		this.idx_of_left_context_abst = idx_of_left_context;
		this.idx_of_sense_abst = idx_of_sense;
	...
	// 表示の順序はこのメソッドで定義する
	public static Object[] get_row_object_list (RetrievedKeyword_IWA rk,int id) {
		Object[] obj = { id,
